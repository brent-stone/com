  ...
  return (
    <main className="flex items-center justify-center pt-16 pb-4">
      <div className="flex min-h-0 flex-1 flex-col items-center gap-16">
        ...
        <div>
          <span className="text-3xl font-bold text-yellow-300">lets </span>
          <span className="text-3xl font-bold text-green-600">Mine</span>
          <span className="text-3xl font-bold text-red-500">craft</span>
        </div>
